...
For each option, investigate systematically using this template:

**Research Template:**
```markdown
Research: [Option Name] for [Topic/decision description]
...
```markdown
## Trade-off Comparison: [Topic/decision description]
...
```markdown
## Recommendation: [Topic/decision description]
...
## Context
[Background and requirements driving this decision - draw from _`TOPIC`_ and Phase 1 scope]
